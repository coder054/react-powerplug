...
The Form component is used for when it's necessary to count something.  
...
<Props>
  <Prop name="initial" type="object" default={"{}"}>
    Specifies the initial value for fields in the form
  </Prop>
  <Prop name="onChange" type="function">
    The onChange event of the Form is called whenever the on state changes.
  </Prop>
